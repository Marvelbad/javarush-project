...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.printf("Имя: %s, год поступления: %d%n", anna.studentName, anna.enrollmentYear);
        System.out.printf("Имя: %s, год поступления: %d%n", ivan.studentName, ivan.enrollmentYear);
    }
}
