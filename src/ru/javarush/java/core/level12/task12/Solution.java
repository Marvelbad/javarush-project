...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        Path originalPath = Path.of("letters.bin");
        Path copyPath = Path.of("letters_copy.bin");

        // Считываем все байты исходного файла с помощью Files.readAllBytes
        byte[] originalFile = Files.readAllBytes(originalPath);

        // Записываем байты в новый файл с помощью Files.write
        Files.write(copyPath, originalFile);
